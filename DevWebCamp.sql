...
CREATE DATABASE IF NOT EXISTS `devwebcamp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `devwebcamp`;
...
-- Volcando datos para la tabla devwebcamp.categorias: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla devwebcamp.eventos_registros: ~11 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `ponentes` (
  ...
  `pais` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `redes` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`)
...
-- Volcando datos para la tabla devwebcamp.usuarios: ~0 rows (aproximadamente)
